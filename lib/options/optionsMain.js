...
async function getOptions(rawOptions) {
    ...
    const options = {
        packager: {
            ...
            portable: (_g = rawOptions.portable) !== null && _g !== void 0 ? _g : false,
            ...
            upgradeFrom: (_h = rawOptions.upgradeFrom) !== null && _h !== void 0 ? _h : (rawOptions.upgrade || undefined),
            win32metadata: (_j = rawOptions.win32metadata) !== null && _j !== void 0 ? _j : {
        ...
        nativefier: {
            ...
            alwaysOnTop: (_k = rawOptions.alwaysOnTop) !== null && _k !== void 0 ? _k : false,
            ...
            blockExternalUrls: (_l = rawOptions.blockExternalUrls) !== null && _l !== void 0 ? _l : false,
            bookmarksMenu: rawOptions.bookmarksMenu,
            bounce: (_m = rawOptions.bounce) !== null && _m !== void 0 ? _m : false,
            browserwindowOptions: rawOptions.browserwindowOptions,
            clearCache: (_o = rawOptions.clearCache) !== null && _o !== void 0 ? _o : false,
            counter: (_p = rawOptions.counter) !== null && _p !== void 0 ? _p : false,
            crashReporter: rawOptions.crashReporter,
            disableContextMenu: (_q = rawOptions.disableContextMenu) !== null && _q !== void 0 ? _q : false,
            disableDevTools: (_r = rawOptions.disableDevTools) !== null && _r !== void 0 ? _r : false,
            disableGpu: (_s = rawOptions.disableGpu) !== null && _s !== void 0 ? _s : false,
            diskCacheSize: rawOptions.diskCacheSize,
            disableOldBuildWarning: (_t = rawOptions.disableOldBuildWarningYesiknowitisinsecure) !== null && _t !== void 0 ? _t : false,
            ...
            showMenuBar: (_3 = rawOptions.showMenuBar) !== null && _3 !== void 0 ? _3 : false,
            singleInstance: (_4 = rawOptions.singleInstance) !== null && _4 !== void 0 ? _4 : false,
            titleBarStyle: rawOptions.titleBarStyle,
            tray: (_5 = rawOptions.tray) !== null && _5 !== void 0 ? _5 : 'false',
            userAgent: rawOptions.userAgent,
            userAgentHonest: (_6 = rawOptions.userAgentHonest) !== null && _6 !== void 0 ? _6 : false,
            verbose: (_7 = rawOptions.verbose) !== null && _7 !== void 0 ? _7 : false,
            versionString: rawOptions.versionString,
            width: (_8 = rawOptions.width) !== null && _8 !== void 0 ? _8 : 1280,
            height: (_9 = rawOptions.height) !== null && _9 !== void 0 ? _9 : 800,
            minWidth: rawOptions.minWidth,
            minHeight: rawOptions.minHeight,
            maxWidth: rawOptions.maxWidth,
            maxHeight: rawOptions.maxHeight,
            widevine: (_10 = rawOptions.widevine) !== null && _10 !== void 0 ? _10 : false,
            x: rawOptions.x,
            y: rawOptions.y,
            zoom: (_11 = rawOptions.zoom) !== null && _11 !== void 0 ? _11 : 1.0,
        },
    };
