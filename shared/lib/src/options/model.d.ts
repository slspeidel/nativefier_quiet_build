...
export declare type TitleBarValue = 'default' | 'hidden' | 'hiddenInset' | 'customButtonsOnHover';
export declare type TrayValue = 'true' | 'false' | 'start-in-tray';
...
export declare type BrowserWindowOptions = Record<string, unknown> & {
    webPreferences?: Record<string, unknown>;
};
export declare type GlobalShortcut = {
    key: string;
    inputEvents: {
...
export declare type NativefierOptions = Partial<AppOptions['packager'] & AppOptions['nativefier']>;
export declare type OutputOptions = NativefierOptions & {
    blockExternalUrls: boolean;
    browserwindowOptions?: BrowserWindowOptions;
    buildDate: number;
    companyName?: string;
...
export declare function outputOptionsToWindowOptions(options: OutputOptions): WindowOptions;
